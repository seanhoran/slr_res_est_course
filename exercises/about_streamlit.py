...
def about_streamlit():
  ...
  text += "We provide reproducable scripts to peers and clients in difficult to use and outdated interfaces embedded in the commercial packages, "
  ...
  st.markdown(text)
  st.text("")
  st.markdown("See the video below for an example of using python and streamlit in Datamine. Skip to minute 10 for the [streamlit](https://streamlit.io/) demonstration.")

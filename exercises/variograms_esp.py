...
def variograms():
  ...
  s,n,r = ex_var(example=1, 
           ...
           key_nugget='nug1', key_range='range1', key_stype='stype1', 
           im='sim1.jpg')
#   st.markdown("## Respuesta: Modelo esferico, efecto pepita moderado a bajo, p. 0,2-0,3 y alcance moderado a largo, p. 60-80m")
...
#   st.markdown("## Respuesta: Modelo de potencia, efecto pepita bajo, p. 0,0-0,1 y alcance moderado a largo, p. 50-70m")
  ...
  s,n,r = ex_var(example=4, 
           hint='Pista: Aqui es cuando te preguntas por que te molestas en levantarte por la manana.', 
           key_nugget='nug4', key_range='range4', key_stype='stype4', 
           im='sim4.jpg')
#   st.markdown("## Respuesta: Modelo esferico, efecto pepita alto, p. 0,4-0,6 y alcance moderado a corto, p. 20-30m")
